...
async function initAppV2() {
    try {
        console.log('========================================');
        console.log('AI-Evolve V3 应用启动（像素级动画）');
        console.log('========================================\n');

        // 调试：检查各个类是否已加载
        console.log('[V3 调试] 检查依赖加载...');
        console.log('[V3 调试] ModelTracker 定义:', typeof ModelTracker !== 'undefined' ? '✓' : '✗');
        console.log('[V3 调试] PixelAnimator 定义:', typeof PixelAnimator !== 'undefined' ? '✓' : '✗');
        console.log('[V3 调试] ChartV3 定义:', typeof ChartV3 !== 'undefined' ? '✓' : '✗');
        console.log('[V3 调试] ChartAnimatorV3 定义:', typeof ChartAnimatorV3 !== 'undefined' ? '✓' : '✗');
        console.log('[V3 调试] ARENA_DATA 定义:', typeof ARENA_DATA !== 'undefined' ? '✓' : '✗');
        console.log('');
        ...
        // 初始化图表V3
        console.log('\n初始化图表V3...');
        chartV2 = new ChartV3('chart');
        console.log('✓ 图表V3初始化完成');
        ...
        // 初始化动画器V3
        console.log('\n初始化动画器V3...');
        animatorV2 = new ChartAnimatorV3(data, chartV2);
        animatorV2.initControls();
        console.log('✓ 动画器V3初始化完成');
