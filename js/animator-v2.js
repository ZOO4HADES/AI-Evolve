/**
 * Animator V2 - 像素级动画控制器
 * 使用 ChartV2 和 PixelAnimator
 */

/**
 * ChartAnimatorV2类
 */
class ChartAnimatorV2 {
    ...
    initControls() {
        ...
        console.log('[AnimatorV2] Controls initialized');
        console.log('[AnimatorV2] Keyboard shortcuts: Space=Play/Pause, Arrow Left/Right=Prev/Next, 1/2/3=Speed');
    }
    ...
    destroy() {
        this.pause();
        console.log('[AnimatorV2] Destroyed');
    }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { ChartAnimatorV2 };
}
